...
class not_active_doctor extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _not_active_doctor();
  }
}

class _not_active_doctor extends State<not_active_doctor> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<control>(context, listen: false).cleandatadoctorinpagenotactivedoctor();
    });
